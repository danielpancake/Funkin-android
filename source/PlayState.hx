...
class PlayState extends MusicBeatState {
	...
	private var mobileControl:FlxTypedGroup<FlxSprite>;
	...
	override public function create() {
		/*
			Harcoded shit for now
		 */
		var tex = Paths.getSparrowAtlas("BOYFRIEND");
		var arrow:FlxSprite = new FlxSprite(100, 100);
		arrow.frames = tex;
		arrow.animation.addByPrefix("singUP", "BF NOTE UP0", 24, false);
		arrow.animation.addByPrefix("singLEFT", "BF NOTE LEFT0", 24, false);
		arrow.animation.addByPrefix("singRIGHT", "BF NOTE RIGHT0", 24, false);
		arrow.animation.addByPrefix("singDOWN", "BF NOTE DOWN0", 24, false);
		add(arrow);
		...
		mobileControl = new FlxTypedGroup<FlxSprite>();
